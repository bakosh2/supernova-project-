...
struct TodaysMissionsView: View {
    ...
    private let allConstellations: [Constellation] = [
        // The refined interactive rocket used before the house update.
        Constellation(
            grayImage: "rocket2_gray",
            completeImage: "rocket2_complete",
            canvasSize: CGSize(width: 1812, height: 2177),
            points: [
                CGPoint(x: 0.500, y: 0.100),
                CGPoint(x: 0.130, y: 0.595),
                CGPoint(x: 0.870, y: 0.595),
                CGPoint(x: 0.335, y: 0.740),
                CGPoint(x: 0.665, y: 0.740)
            ],
            usesArtwork: false,
            collectionOrder: [1, 0, 2, 4, 3],
            links: [
                .init(startStar: 1, endStar: 0, points: [
                    CGPoint(x: 0.130, y: 0.595), CGPoint(x: 0.275, y: 0.500),
                    CGPoint(x: 0.320, y: 0.465), CGPoint(x: 0.320, y: 0.265),
                    CGPoint(x: 0.450, y: 0.150), CGPoint(x: 0.500, y: 0.100)
                ]),
                .init(startStar: 0, endStar: 2, points: [
                    CGPoint(x: 0.500, y: 0.100), CGPoint(x: 0.550, y: 0.150),
                    CGPoint(x: 0.680, y: 0.265), CGPoint(x: 0.680, y: 0.465),
                    CGPoint(x: 0.725, y: 0.500), CGPoint(x: 0.870, y: 0.595)
                ]),
                .init(startStar: 1, endStar: 3, points: [
                    CGPoint(x: 0.130, y: 0.595), CGPoint(x: 0.130, y: 0.755),
                    CGPoint(x: 0.275, y: 0.755), CGPoint(x: 0.335, y: 0.740)
                ]),
                .init(startStar: 3, endStar: 4, points: [
                    CGPoint(x: 0.335, y: 0.740), CGPoint(x: 0.665, y: 0.740)
                ]),
                .init(startStar: 4, endStar: 2, points: [
                    CGPoint(x: 0.665, y: 0.740), CGPoint(x: 0.725, y: 0.755),
                    CGPoint(x: 0.870, y: 0.755), CGPoint(x: 0.870, y: 0.595)
                ])
            ]
        ),
        Constellation(
        ...
        Constellation(
            ...
            links: [
                ...
                .init(startStar: 1, endStar: 2, points: [CGPoint(x: 0.105, y: 0.490), CGPoint(x: 0.895, y: 0.490)]),
        ...
        // The second rocket keeps the same interactive, code-drawn outline.
        Constellation(
            grayImage: "rocket2_gray",
            completeImage: "rocket2_complete",
            canvasSize: CGSize(width: 1812, height: 2177),
    ...
    private var constellation: some View {
        ZStack {
            ...
            if currentConstellation.grayImage == "rocket2_gray" && !currentConstellation.usesArtwork {
                refinedRocketDecoration
            ...
            // Artwork-based constellations contain their own unfilled stars,
            // so no extra SwiftUI nodes are drawn over the supplied image.
            if !currentConstellation.usesArtwork {
    ...
    private var refinedRocketDecoration: some View {
        let details = Path { path in
            path.addRoundedRect(
                in: CGRect(
                    x: constellationSize.width * 0.415,
                    y: constellationSize.height * 0.295,
                    width: constellationSize.width * 0.19,
                    height: constellationSize.height * 0.135
                ),
                cornerSize: CGSize(width: constellationSize.width * 0.025, height: constellationSize.width * 0.025)
            )

            path.move(to: CGPoint(x: constellationSize.width * 0.320, y: constellationSize.height * 0.465))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.320, y: constellationSize.height * 0.690))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.380, y: constellationSize.height * 0.740))

            path.move(to: CGPoint(x: constellationSize.width * 0.680, y: constellationSize.height * 0.465))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.680, y: constellationSize.height * 0.690))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.620, y: constellationSize.height * 0.740))

            path.move(to: CGPoint(x: constellationSize.width * 0.500, y: constellationSize.height * 0.740))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.500, y: constellationSize.height * 0.900))
            path.move(to: CGPoint(x: constellationSize.width * 0.470, y: constellationSize.height * 0.790))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.435, y: constellationSize.height * 0.860))
            path.move(to: CGPoint(x: constellationSize.width * 0.530, y: constellationSize.height * 0.790))
            path.addLine(to: CGPoint(x: constellationSize.width * 0.565, y: constellationSize.height * 0.860))
        }
        ...
        return ZStack {
            ...
            Image(systemName: "star.fill")
                ...
                .scaledToFit()
                .frame(width: constellationStarSize, height: constellationStarSize)
                .foregroundStyle(allStarsFilled ? gold : Color.gray)
                .position(x: constellationSize.width * 0.500, y: constellationSize.height * 0.940)
        }
    }
